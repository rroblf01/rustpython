...
//   parser.rs        ~270  — Parser struct, helpers, parse_program, try_parse
//   parser/stmt.rs   ~960  — statement dispatch, simple stmts, args, block
//   parser/compound.rs ~600 — def/class/if/while/for/with/try/match/type_alias
//   parser/pattern.rs ~289 — match-case pattern parsing (this POC)
//   parser/expr.rs    ~355 — expression precedence (this POC, subset)
//   parser/import.rs  ~117 — import handling (this POC)
//   parser/atom.rs   ~950 — atom/fstring/lambda/yield (future)
// POC extracts 3 smallest logical groups: pattern, expr, import.
mod expr;
pub use expr::*;
mod import;
pub use import::*;
