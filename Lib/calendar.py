...
# Fix __module__ on functions for test support compatibility
for _name in list(__all__):
    _obj = globals().get(_name)
    if _obj is not None and not isinstance(_obj, type) and callable(_obj) and getattr(_obj, '__module__', None) is None:
